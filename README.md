...
This is an ALX collaboration project on Shell between kehinde opaleye and Peter Igbo. We were tasked to create a simple shell that mimics the Bash shell. Our shell shall be called hsh
